...
const CellBaseSchema = new mongoose.Schema({
  ...
  qr:     { type: String, default: null, index: true }, // para escanear
  createdBy:   { userId: String, name: String },
  updatedBy:   { userId: String, name: String }
}, { _id: false });

const CLMatrixEsfericoSchema = new mongoose.Schema({
...
module.exports = mongoose.model('CLMatrixEsferico', CLMatrixEsfericoSchema);
