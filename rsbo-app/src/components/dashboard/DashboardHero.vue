...
.profile-cta {
  ...
  padding:0.65rem 0.9rem; border-radius:0.9rem;
...
.profile-cta:hover { background:var(--bg-muted); transform:translateY(-2px); box-shadow:0 4px 16px rgba(0,0,0,0.15); }
.pcta-avatar { width:38px; height:38px; border-radius:50%; object-fit:cover; border:1.5px solid var(--border); }
...
.hqs-sep   { width:1px; height:30px; background:var(--border); }
