          ...
          <div class="an-kpi-card">
            ...
            <div class="an-kpi-inner">
              ...
              <div>
                ...
                <div class="an-kpi-cap">SPH · CYL · ADD</div>
              </div>
            </div>
          </div>
          <div class="an-kpi-card">
      ...
      <div class="an-col-main">
        ...
        <div v-if="canSeeMovements" class="gcard mb-5">
          ...
          <div class="gc-head">
            ...
            <div>
              <div class="gc-title">Actividad de inventario</div>
              <div class="gc-sub">Movimientos registrados — últimos 30 días</div>
            </div>
          </div>
          <div class="gc-body">
            <div class="an-trio">
        ...
        <div v-if="canSeeInventory" class="gcard mb-5">
          ...
          <div class="gc-head">
            ...
            <div>
              <div class="gc-title">Distribución por tipo de lente</div>
              <div class="gc-sub">Porcentaje de piezas activas por familia de producto</div>
            </div>
          </div>
          <div class="gc-body">
            <div v-if="!isLoading">
      ...
      <div class="an-col-side">
        ...
        <div v-if="canSeeInventory" class="gcard mb-4">
          ...
          <div class="gc-head">
            ...
            <div>
              <div class="gc-title">Cobertura de inventario</div>
              <div class="gc-sub">Estado general del stock del catálogo</div>
            </div>
          </div>
          <div class="gc-body">
            <template v-if="!isLoading">
